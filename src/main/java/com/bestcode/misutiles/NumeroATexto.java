...
public class NumeroATexto {
    ...
    public static final String[] UNIDADES = {"", "un ", "dos ", "tres ", "cuatro ", "cinco ", "seis ", "siete ", "ocho ", "nueve "};
    public static final String[] DECENAS = {"diez ", "once ", "doce ", "trece ", "catorce ", "quince ", "dieciseis ",
        "diecisiete ", "dieciocho ", "diecinueve", "veinte ", "treinta ", "cuarenta ",
        "cincuenta ", "sesenta ", "setenta ", "ochenta ", "noventa "};
    public static final String[] CENTENAS = {"", "ciento ", "doscientos ", "trecientos ", "cuatrocientos ", "quinientos ", "seiscientos ",
...
//            parte_decimal = "y " + Num[1] + "/100 Soles.";
    ...
    private static String getMillones(String numero) { //000 000 000        
        ...
        System.out.println("millon.length() = " + millon.length());
        //if (millon.length() > 1) {
        if (!millon.equals("1")) {
